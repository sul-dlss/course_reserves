...
set :linked_files, %w{config/database.yml config/secrets.yml config/initializers/squash_exceptions.rb config/initializers/environment_specific_settings.rb config/honeybadger.yml}
