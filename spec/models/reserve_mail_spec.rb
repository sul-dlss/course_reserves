...
RSpec.describe ReserveMail do
  ...
  describe ".first_request" do
    ...
    it "returns the item list formatted correctly" do
      email = ReserveMail.first_request(Reserve.create(reserve_params.merge(item_list: [{ "ckey" => "12345", "title" => "SW Item", 'imprint' => '1st ed. - Mordor', "copies" => "2", "loan_period" => "4 hours" }])), "test@example.com", "jdoe")
      body = email.body.raw_source
